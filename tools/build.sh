...
build index.html       ""            "전남 줄넘기의 모든 일정"        "전남한국줄넘기협회 공식 홈페이지. 대회 접수와 마감일, 지도자 연수, 자격증 발급, 전라남도 22개 시·군 등록 클럽 정보를 한곳에서 확인하세요."
build about.html       about         "협회소개"                      "전남한국줄넘기협회의 인사말, 미션과 비전, 연혁, 조직도와 임원 현황을 소개합니다."
build competition.html competition   "대회"                          "전남한국줄넘기협회 연간 대회 일정, 스피드·프리스타일·음악줄넘기 등 경기 종목과 규정, 참가 신청 안내."
...
build news.html        news          "소식"                          "전남한국줄넘기협회 공지사항, 보도자료, 대회 요강 및 서식 자료실입니다."
build gallery.html     news          "갤러리"                        "전남한국줄넘기협회 대회와 연수, 행사 현장의 사진 기록입니다."
build contact.html     contact       "문의 · 오시는 길"              "전남한국줄넘기협회 사무국 위치와 연락처, 온라인 문의, 자주 묻는 질문을 확인하세요."
